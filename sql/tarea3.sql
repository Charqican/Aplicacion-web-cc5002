...
-- -----------------------------------------------------
-- Table `tarea3`.`geodatadonacion`
-- date will be repeated from donacion, but I belive this will speedup the process
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `tarea2`.`geodata` (
  `id` INT NOT NULL,
  `lat` FLOAT,
  `lon` FLOAT,
  PRIMARY KEY (`id`),
  FOREIGN KEY (`id`) REFERENCES `tarea2`.`comuna` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION)
ENGINE = InnoDB;
